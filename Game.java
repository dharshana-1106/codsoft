...
{  
	...
	{   
		...
		for(int i=1; i<=4; i++)
		{
			System.out.println("Enter your guess. Your limit is"+" "+(5-i));
			int num=s.nextInt();
			if(num==secretnum10)
			{
	...
	public static void hard(Scanner s)
	{
		...
		for(int i=1; i<=10; i++)
		{
			System.out.println("Enter your guess. Your limit is"+" "+(11-i));
	...
	public static void main(String args[])
	{
		...
		System.out.println("Ready to play within the 1-10 range? yes/no...(if no, the game starts within the 1-100 range)");
